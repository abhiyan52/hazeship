...
> Vendored unmodified from [blader/humanizer](https://github.com/blader/humanizer)
> (MIT license, see `LICENSE` in this folder). Update by re-pulling
> `SKILL.md` from that repo rather than hand-editing this copy.
